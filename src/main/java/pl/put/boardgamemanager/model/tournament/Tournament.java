package pl.put.boardgamemanager.model.tournament;
...
@Entity
@javax.persistence.Table(name = "tournaments", schema = "public", catalog = "postgres")
public class Tournament implements Model, TimeEvent {
    ...
    public void updateParamsFrom(DTO dto) {
        if(dto instanceof TournamentDTO) {
            ...
            this.setGameId(tournamentDTO.getGameId());
            this.setDuration(tournamentDTO.getDuration());
            this.setStartTime(Timestamp.valueOf(tournamentDTO.getStartTime()));
            this.setMaxPlayers(tournamentDTO.getMaxPlayers());
        }
    }
