package pl.put.boardgamemanager.model.game;
...
@Entity
@javax.persistence.Table(name = "games", schema = "public", catalog = "postgres")
public class Game implements Model {
    ...
    public void updateParamsFrom(DTO dto) {
        if(dto instanceof GameDTO) {
            ...
            this.setPublisher(gameDTO.getPublisher());
            this.setMinPlayers(gameDTO.getMinPlayers());
            this.setMaxPlayers(gameDTO.getMaxPlayers());
            this.setAvgTime(gameDTO.getAvgTime());
